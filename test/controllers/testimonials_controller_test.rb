...
class TestimonialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post testimonials_url, params: { testimonial: { company_name: @testimonial.company_name, description: @testimonial.description, mentor_name: @testimonial.mentor_name } }
    end
  ...
  test "should update testimonial" do
    patch testimonial_url(@testimonial), params: { testimonial: { company_name: @testimonial.company_name, description: @testimonial.description, mentor_name: @testimonial.mentor_name } }
