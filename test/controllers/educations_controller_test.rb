...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { college: @education.college, course: @education.course, description: @education.description, year: @education.year } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { college: @education.college, course: @education.course, description: @education.description, year: @education.year } }
